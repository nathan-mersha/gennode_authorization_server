...
/**
 * @api             {post} /auth/admin/signup     SignUp
 * @apiVersion      0.0.1
 * @apiName         SignUp
 ...
 *
 *
 * @apiSampleRequest http://localhost:3333/auth/admin/signup
 *
...
/**
 * @api             {post} /auth/admin/login     Login
 * @apiVersion      0.0.1
 * @apiName         Login
 * @apiGroup        Administrator
 ...
 *
 *
 * @apiSampleRequest http://localhost:3333/auth/admin/login
 *
 * @apiError    (400)       {Object}    AUTHENTICATION_NOT_SET              - Authentication values are not set.
 * @apiError    (400)       {Object}    AUTHENTICATION_TYPE_NOT_ACCORD      - Authentication type is not according to constants.
 * @apiError    (400)       {Object}    AUTHENTICATION_VALUE_NOT_SET        - Authentication values are not set.
...
/**
 * @api             {get} /auth/admin/count     Count
 * @apiVersion      0.0.1
 * @apiName         Count
 * @apiGroup        Administrator
 ...
 *
 * @apiSampleRequest http://localhost:3333/auth/admin/count
 *
 * @apiError    (400)       {Object}    AUTHENTICATION_NOT_SET              - Authentication values are not set.
 * @apiError    (400)       {Object}    AUTHENTICATION_TYPE_NOT_ACCORD      - Authentication type is not according to constants.
 * @apiError    (400)       {Object}    AUTHENTICATION_VALUE_NOT_SET        - Authentication values are not set.
 ...
 *
 * @apiSampleRequest http://localhost:3333/auth/admin
 *
 * @apiError    (400)       {Object}    AUTHENTICATION_NOT_SET              - Authentication values are not set.
 * @apiError    (400)       {Object}    AUTHENTICATION_TYPE_NOT_ACCORD      - Authentication type is not according to constants.
 * @apiError    (400)       {Object}    AUTHENTICATION_VALUE_NOT_SET        - Authentication values are not set.
